  ...
  return knex('farms').del()
    .then(function() {
      ...
      return knex('farms').insert([{
          id: 1,
          name: "Agricultural Heritage Center at the Lohr/McIntosh Farm",
        ...
        {
          id: 3,
          name: "Boulder Bike Tours: Bike-to-Organic Farm Tours",
        ...
        {
          id: 4,
          name: "Boulder County Farmers Market – Boulder",
        ...
        {
          id: 5,
          name: "Boulder County Farmers Market – Longmont",
        ...
        },
        {
          ...
          contact: "bouldercolorado.gov/osmp/ cultural-resources-antique-farmequipment-exhibit",
        ...
        {
          id: 19,
          name: "Rock Creek Farm Pumpkin Patch & Corn Maze",
